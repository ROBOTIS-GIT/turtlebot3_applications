...
if __name__ == '__main__':
    ...
    labels = {'30_0':0, '30_l':1, '30_r':2, '45_0':3, '45_l':4, '45_r':5, 'empty':6}
...
#################################################### WORKING with 0-70 to 290- 360 #############################################
    ...
    for i in range(len(comments)):
        ...
        for x in range(70,-1,-1) + range(359, 289,-1):
            ...
            elif (x+1) in range(70,-1,-1) + range(359, 289,-1) and (x-1) in range(70,-1,-1) + range(359, 289,-1) and np.nan_to_num(laser_data[i].ranges[x]) == 0:
        ...
        for x in range(70,-1,-1) + range(359, 289,-1):
            ...
            elif (x+1) in range(70,-1,-1) + range(359, 289,-1) and (x-1) in range(70,-1,-1) + range(359, 289,-1) and np.nan_to_num(laser_data[i].intensities[x]) == 0:
