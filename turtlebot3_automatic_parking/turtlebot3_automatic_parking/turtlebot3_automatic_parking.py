...
class AutomaticParking(Node):
    ...
    def __init__(self):
        ...
        self.SPOT_CENTER_MARGIN = 20
        self.MIN_SPOT_CANDIDATES = 10
        self.SEARCH_FAIL_LIMIT = 100
        self.ROTATION_SPEED = 0.2
        self.ROTATION_TOLERANCE = 0.1
        self.LINEAR_SPEED = 0.05
        self.REVERSE_SPEED = 0.04
        self.REAR_SCAN_ANGLE_MIN = 150
        self.REAR_SCAN_ANGLE_MAX = 210
        self.PARKING_STOP_DISTANCE = 0.13
